...
mod tests {
    ...
    fn a_punch_through_mod_reaches_the_panel() {
        ...
        let bare = crate::loadout::resolve(&base, &[], crate::model::StackPolicy::Emergent);
        ...
        let with = crate::loadout::resolve(&base, &[auger], crate::model::StackPolicy::Emergent);
        ...
        let assumed = crate::loadout::resolve(&base, &[auger], crate::model::StackPolicy::AssumedMax);
        assert!(

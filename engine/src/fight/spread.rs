...
pub(super) fn spread_from_influence(
    ...
    for (b, at) in bodies.iter().copied().enumerate() {
        ...
        for &(ty, elem_raw) in landed {
            ...
            ledger::settle(
                r, rec, t, Combatant::WIELDER, b, ty, PopKind::Extra, &breakdown, settled, Some(dbf),
                ledger::Clock::Hit,
                || Instance {
...
pub(super) fn spread_hit(
    ...
    ledger::settle(
        r, rec, t, Combatant::WIELDER, inst.target, shares.dominant(),
...
pub(super) fn fire_syndicate_radial(
    ...
    ledger::settle(
        r, rec, at, Combatant::WIELDER, 0, sy.element, PopKind::Arcane, &breakdown, settled,
        Some(debuffs),
        ledger::Clock::Hit,
        || Instance {

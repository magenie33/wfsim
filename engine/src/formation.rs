...
impl Formation {
    ...
    pub fn one(params: crate::target::Foe, body_parts: Vec<crate::target::BodyPart>, at: Vec2) -> Self {
...
mod tests {
    ...
    fn spec() -> (crate::target::Foe, Vec<crate::target::BodyPart>) {
        (
            crate::target::Foe::training_dummy(),

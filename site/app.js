...
const BUILD_ID = "3342af8c+ · 2026-08-31 04:57Z";
...
const PROJECT_FACTS = {"rust_tests": 920, "browser_checks": 58, "commits": 2125, "first_commit_day": "2026-07-23"};
...
let sim = { enemy: "thrax_centurion", level: 9999, steel_path: true, eximus: null, headshot_pct: 100, aiming: true,
  ...
  // this app has always run. See `renderBuffEvents`.
  buff_events_off: [],
  frame: "",
...
/// docs/BUFFS.md and the vocabulary is `/api/meta.buff_events`. ONLY THE KINDS
/// THIS WEAPON ASKS FOR are drawn, plus any already switched off, so swapping
/// weapons drops no term of the fight.

...
| `artifact_mods/` | Antique mods for the Operator's Tektolyst Artifact | `school`, `max_rank`, `description` (the card at max rank), `bonus_per` (`unique_school` or a school id) |
